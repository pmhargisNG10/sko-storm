...
import com.hortonworks.common.util.CacheUtil2;
...
public class DtsMonitorBolt implements IRichBolt
{
    private static final Logger LOG = Logger.getLogger(DtsMonitorBolt.class);
